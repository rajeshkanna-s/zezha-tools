  ...
  return (
    <div style={{ maxWidth: 860, margin: '0 auto', padding: 16 }}>
      ...
      <div style={{ background: 'white', borderRadius: 14, border: '1px solid #e2e8f0', padding: 18 }}>
          ...
          {[
            ...
            <button
              ...
              style={{
                ...
                borderRadius: 8,
                cursor: 'pointer',
                background: calcMode === mode ? '#2563eb' : '#f1f5f9',
        ...
        {result && !result.error && (
          <div style={{ borderRadius: 14, border: '1px solid #bfdbfe', background: '#eff6ff', padding: 16, marginTop: 14 }}>
              ...
              <div>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 8, marginBottom: 8 }}>
                  {[
                    ...
                    ['Total Payment', fmt(result.totalPayment), '#059669', 'payment' as const]
                  ].map(([l, v, c, type], i) => (
                    <div key={i}
